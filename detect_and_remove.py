...
def dhash(image, hashSize=8):
    ...
    # convert sthe difference image to a hash and return it
...
# grab the paths to all immages in our input dataset directory and
# then initialize our hashes directory
    ...
    if len(hashedPaths) > 1:
        ...
        if args["remove"] <= 0:
            ...
            for p in hashedPaths:
                # load the image and resize it to a fixed width
                # and height
                image = cv2.imread(p)
